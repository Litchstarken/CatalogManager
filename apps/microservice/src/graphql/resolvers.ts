...
export const resolvers = {
  ...
  Mutation: {
    ...
    updateProduct: async (_: any, args: {
      id: string;
      name?: string;
      description?: string;
      price?: number;
      ...
      const existing = await database.get('SELECT * FROM products WHERE id = ?', args.id);
    ...
    register: async (_: any, args: { email: string; password: string; role: string }) => {
